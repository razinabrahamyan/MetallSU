...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card list_card list_edit_card">
                <div class="card-body">
                    <div class="card-title">
                        ...
                        <form action="{{route('lists.update')}}" method="post">
                            ...
                            <div class="">
                                <div>
                                    @foreach($base->orderedResponsible as $item)
                                        ...
                                        <div class="main_edit_block">
                                            <div class="d-flex align-items-center position_edit_card" data-iteration="{{$loop->index}}"  data-parent="{{$item->id}}">
                                                <a href="{{route('responsible',$item->id)}}"><i class="bx bx-bar-chart-square font-22"></i></a>
                                                <div class="form-group p-1 inputs">
                                                    <input autocomplete="off" disabled required value="{{$item->name}}" type="text" name="items[{{$loop->index}}][title]" class="form-control main_value" >
                                ...
                                <div class="ms-3">
                                    ...
                                    <div class="new_item_button_handler p-1"><button type="button" class="btn btn-light add_main_block">Добавить поле <i class="bx bx-plus"></i></button></div>
                                </div>
                                <div class="edit_form_submit">
                                    <div >
                                        <button type="submit" class="btn btn-light pos_save save_items text-white mt-4">Сохранить<i class="bx bx-save"></i></button>
