...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <worker-page-component></worker-page-component>

        </div>
    </div>

    @push('scripts')
        <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.3/moment.min.js" integrity="" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        <script>
