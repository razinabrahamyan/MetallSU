            ...
            <div class="card mb-5">
                <div class="card-body">
                    <div class="card-title">
                        ...
                        <form action="{{route('bases.update')}}" method="post">
                            ...
                            <div class="d-flex">
                                <div>
                                    ...
                                    @forelse($bases as $position)

                                        <div class="main_edit_block">
                                            <div class="d-flex align-items-center position_edit_card" data-iteration="{{$loop->index}}"  data-parent="{{$position->id}}">
        ...
        <script>
            function childElem(parent_id){
                ...
                return ('<div class="d-flex align-items-center position_edit_card editable new_added">' +
                    ...
                    '                   <input value="'+ parent_id +'" type="hidden" name="new_child['+ index +'][parent_id]" class="form-control  main_value" >' +
                    '                </div>' +
                    '            <div>' +
                    '                <button class="btn btn-light should_dis edit_button" type="button"><i class="bx bx-edit"></i></button>' +
