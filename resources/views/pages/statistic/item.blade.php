                            ...
                            <div class="card-title stat_card_sums">
                                ...
                                <div>
                                    ...
                                    <span class="should_money">
                                        {{$item->costs->where('date','>=',now()->firstOfMonth())->sum('value')}}
                                    </span>
                                        ({{$item->costs->where('date','>=',now()->firstOfMonth())->sum('count')}})
                                ...
                                <div>
                                    <h3>
                                    <span class="should_money">
                                        {{$item->costs->sum('value')}}
                                    </span>
                                        ({{$item->costs->sum('count')}})
                                    </h3>
        ...
        $(document).ready(function (){
            ...
            $('#apply_filters').click(function (){
                ...
                $.ajax({
                    ...
                    url: "{{route('statistic.filter.items')}}"+"?"+$('#stat_form').serialize(),
                    data: {
